...
namespace TrackerLibrary
{
    ...
    public class PrizeModel
    {
        ...
        /// <summary>
        /// The numeric identifier for the place (2 for decond place, etc.)
        /// </summary>
        ...
        /// <summary>
        /// The fixed amount this place earsn or zemo if it is not used.
        /// </summary>
        public decimal PrizeAmount { get; set; }
        /// <summary>
        /// The number represents the percentage of the overall take or
        /// zero if it is not used. The percantage is a fraction of 1 (0.5 for 50%)
        /// </summary>
